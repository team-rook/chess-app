...
RSpec.describe Piece, type: :model do
  ...
  describe 'horizontal_blocked?' do
    it 'should return true if the horizontal path east is blocked' do
      ...
      Queen.create(x_position: 3, y_position: 0, game_id: game.id)
    ...
    it 'should return false even if destination square is occupied because checking path only' do
      ...
      Pawn.create(x_position: 3, y_position: 3, game_id: game.id)
  ...
  describe 'vertical_blocked?' do
    it 'should return true if the vertical path north is blocked' do
      ...
      Pawn.create(x_position: 3, y_position: 1, game_id: game.id)
    ...
    it 'should return true if the vertical path south is blocked' do
      game = Game.create(white_user_id: 0, black_user_id: 1)
      rook = Rook.create(x_position: 0, y_position: 0, game_id: game.id)
      Pawn.create(x_position: 0, y_position: 1, game_id: game.id)
    ...
    it 'should return false even if destination square is occupied because checking path only' do
      game = Game.create(white_user_id: 0, black_user_id: 1)
      rook = Rook.create(x_position: 3, y_position: 3, game_id: game.id)
      Pawn.create(x_position: 3, y_position: 6, game_id: game.id)
  ...
  describe 'diagonal_blocked?' do
    it 'should return true if the diagonal path northeast is blocked' do
      ...
      Pawn.create(x_position: 6, y_position: 6, game_id: game.id)
    ...
    it 'should return true if the diagonal path northwest is blocked' do
      game = Game.create(white_user_id: 0, black_user_id: 1)
      bishop = Bishop.create(x_position: 5, y_position: 7, game_id: game.id)
      Pawn.create(x_position: 4, y_position: 6, game_id: game.id)
    ...
    it 'should return true if the diagonal path southwest is blocked' do
      ...
      Pawn.create(x_position: 1, y_position: 1, game_id: game.id)
  ...
  describe 'move_to!' do
    ...
    it 'should return true if white pawn capturing en passant' do
      ...
      black_pawn = Pawn.create(move_number: 1, x_position: 0, y_position: 3, game_id: game.id, user_id: black_user.id)
    ...
    it 'should return true if black pawn capturing en passant' do
      ...
      black_user = FactoryGirl.create(:user)
      game = Game.create(white_user_id: white_user.id, black_user_id: black_user.id)
      white_pawn = Pawn.create(move_number: 1, x_position: 0, y_position: 4, game_id: game.id, user_id: white_user.id)
